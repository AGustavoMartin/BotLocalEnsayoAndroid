...
interface AuthRepository {
    ...
    suspend fun requestPinReset(phone: String): PinResetChallenge
    suspend fun confirmPinReset(phone: String, code: String, newPin: String, deviceLabel: String): AppSession
